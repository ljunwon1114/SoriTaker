...
- A real GUI-launched subprocess saved audio only with no installed models, produced one byte-identical WAV and no TXT, removed its temporary recording, and displayed the saved queue state.
